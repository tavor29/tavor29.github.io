...
1. **Back up, then wipe, the memory files.** Whatever CLAUDE.md or memory system has accumulated cruft, start fresh. Cap the new file at roughly 50 lines — force yourself to keep only what's broadly applicable.
